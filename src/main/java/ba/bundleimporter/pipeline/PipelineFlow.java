...
import ba.bundleimporter.pipeline.component.publisher.PublisherFlow;
...
public class PipelineFlow extends PipelineFlowSupport {
    ...
    public static <C> Flow<Pair<byte[],C>, Pair<Done,C>, ?> flow(SerializationFlow<C> serializationFlow,
                                                                       ValidationFlow<C> validationFlow,
                                                                       PublisherFlow<C> publisherFlow,
        ...
        Flow.<Pair<byte[],C>>create()
                ...
                .flatMapConcat(m->applyFlowConditional(publisherFlow.flow(),m))
